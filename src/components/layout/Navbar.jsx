...
export default function Navbar() {
  ...
  async function executeDatabaseReset() {
    ...
    try {
      setIsResetting(true)
      const res = await fetch('https://schoolboard-1.onrender.com/api/auth/reset', {
        method: 'POST',
        headers: {
            ...
            <div className="p-6 space-y-7 overflow-y-auto flex-1 scrollbar-thin">
              ...
              <div className="space-y-3 pt-4 border-t border-border/60">
                ...
                <p className="text-xs text-text-secondary">
                  Limpia y restablece todas las actividades, comentarios y espacios de la base de datos en la nube.
                </p>
