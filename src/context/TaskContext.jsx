...
export function TaskProvider({ children }) {
  ...
  const fetchTasks = useCallback(async () => {
    if (!token) return
    try {
      const res = await fetch('https://schoolboard-rcyh.onrender.com/api/tasks', {
  ...
  const fetchEpics = useCallback(async () => {
    if (!token) return
    try {
      const res = await fetch('https://schoolboard-rcyh.onrender.com/api/epics', {
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
        const data = await res.json()
  ...
  const fetchWorkspaces = useCallback(async () => {
    if (!token) return
    try {
      const res = await fetch('https://schoolboard-rcyh.onrender.com/api/workspaces', {
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
        const data = await res.json()
  ...
  const fetchTeams = useCallback(async () => {
    if (!token) return
    try {
      const res = await fetch('https://schoolboard-rcyh.onrender.com/api/teams', {
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
        const data = await res.json()
  ...
  const fetchColleagues = useCallback(async () => {
    if (!token) return
    try {
      const res = await fetch('https://schoolboard-rcyh.onrender.com/api/colleagues', {
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
        const data = await res.json()
  ...
  const updateTask = useCallback(async (idOrObj, updatedFields) => {
    ...
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const moveTask = useCallback((source, destination) => {
    ...
    setColumns((prev) => {
      ...
      // Persistir cambio
      fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${updatedTask.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const addSubtask = useCallback(async (taskId, title, date) => {
    ...
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}/subtasks`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const toggleSubtask = useCallback(async (taskId, subtaskId, currentCompleted) => {
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}/subtasks/${subtaskId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const addComment = useCallback(async (taskId, commentData, userName) => {
    try {
      ...
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}/comments`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const addEvidenceLink = useCallback(async (taskId, url, name) => {
    try {
      ...
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}/evidences`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const deleteEvidence = useCallback(async (taskId, evidenceId) => {
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/tasks/${taskId}/evidences/${evidenceId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
  ...
  const addTeamMember = useCallback(async (workspaceId, email) => {
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/workspaces/${workspaceId}/invite`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const deleteTeam = useCallback(async (teamId) => {
    try {
      const res = await fetch(`https://schoolboard-rcyh.onrender.com/api/teams/${teamId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      })
      if (res.ok) {
