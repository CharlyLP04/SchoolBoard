...
export function AuthProvider({ children }) {
  ...
  async function login({ email, password }) {
    try {
      const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  async function requestRegistrationCode({ name, email, password }) {
    try {
      const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/register-send-code', {
        method: 'POST',
  ...
  async function register({ email, code }) {
    try {
      const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  async function forgotPassword({ email }) {
    const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/forgot-password', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async function resetPassword({ token, newPassword }) {
    const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/reset-password', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async function updateProfile({ name, email }) {
    try {
      const res = await fetch('https://schoolboard-production-fed9.up.railway.app/api/auth/profile', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
